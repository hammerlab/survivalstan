...
_pem_survival_varcoef_path3 = os.path.join('stan', 'pem_survival_model_varying_coefs3.stan')
...
pem_survival_model_varying_coefs3 = pkg_resources.resource_string(
	resource_package, _pem_survival_varcoef_path3).decode("utf-8") 

...
class SurvivalStanData:
    ...
    def _to_survival_formula(self):
        ''' Process inputs & convert to new survival-formula syntax
        '''
        # does given formula have a LHS component?
        # if so, is LHS a survival-type data?
        # if not, convert given inputs to survival-type formula
        # capture converted survival-type formula
